...
- (IBAction)pay {
  ...
  PayPalItem *item1 = [PayPalItem itemWithName:@"Old jeans with holes"
                                  withQuantity:2
                                     withPrice:[NSDecimalNumber decimalNumberWithString:@"4.99"]
                                  withCurrency:@"MXN"
                                       withSku:@"Hip-00037"];
  NSDecimalNumber *subtotal = [PayPalItem totalPriceForItems:item1];
  
  // Optional: include payment details
  NSDecimalNumber *shipping = [[NSDecimalNumber alloc] initWithString:@"1.99"];
  NSDecimalNumber *tax = [[NSDecimalNumber alloc] initWithString:@"0.50"];
