...
- (void)viewDidLoad
{
    ...
    self.cropper = [[BFCropInterface alloc]initWithFrame:self.displayImage.bounds andImage:self.originalImage andCropFrame:self.frameCrop.bounds];
...
- (IBAction)cropPressed:(id)sender {
    ...
    self.frameCrop.image = croppedImage;
